...
<?php 
         ...
         include 'update_r_modal.php';
          include 'new_room_modal.php';
         #include 'config.php';
								...
								<li><a href="#gallery" data-link-alt="gallery" class="scroll"><span>Gallery</span></a></li>							
                                                               <?php                                           
                                                                    ...
                                                                    if(isset($_SESSION['e_id'])){ 
                                                                       ?>
                                                                 <li class="dropdown"><a href="#" data-link-alt="Rooms" class="dropdown-toggle" data-toggle="dropdown" role="button">Rooms<span class="caret"></span></a>
                                                                     <ul class="dropdown-menu">
                                                                         <li><a href="#update_room_modal" style="color: black;" data-toggle="modal" data-target="#update_room_modal">Update room</a></li>
                                                                        <li><a href="#new_room_modal" style="color: black;" data-toggle="modal" data-target="#new_room_modal">Add new room</a></li>                                                                       
                                                                      </ul>
                                                                 </li>
                                                                    <?php }
